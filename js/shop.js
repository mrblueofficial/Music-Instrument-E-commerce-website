const products = [
  ...
  },
  {
    ...
    price: 73.9,
    currency: "R",
    image: "img/t shirts/clarinet.png",
    type: "new",
    category: "tshirts",
  ...
  {
    name: "Junior Saxophone",
    price: 78.9,
    currency: "R",
    image: "img/t shirts/junior.jpg",
    type: "best",
    category: "tshirts",
    availability: "inStock",
    size: ["XS", "M"],
  ...
  },
  {
    ...
    price: 100,
    currency: "R",
    image: "img/t shirts/tops.webp.avif",
    type: "sale",
    category: "pants",
    availability: "outOfStock",
    size: ["M"],
...
priceRangeInput.addEventListener("input", (event) => {
  ...
  priceMaxDisplay.innerText = `${maxPrice} R`;
  filterProducts();
});
