    ...
    cart.forEach((product, index) => {
      ...
      row.innerHTML = `
        <td class="text-center bg-light">
          <img src="${product.image}" alt="${product.name}" width="100" class="img-fluid mb-2">
          <h5>${product.name}</h5>
        </td>
        <td class="bg-secondary-subtle">
          <h4 class="text-center mt-5">R${product.price.toFixed(2)}</h4>
        </td>
        ...
        <td class="bg-secondary-subtle">
          <h4 class="text-center mt-5">R${itemTotal.toFixed(2)}</h4>
        </td>
        <td class="text-center bg-light">
          <div
